...
class ToDoListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create to_do_list" do
    assert_difference("ToDoList.count") do
      post to_do_lists_url, params: { to_do_list: { completed: @to_do_list.completed, description: @to_do_list.description } }
    end
  ...
  test "should update to_do_list" do
    patch to_do_list_url(@to_do_list), params: { to_do_list: { completed: @to_do_list.completed, description: @to_do_list.description } }
